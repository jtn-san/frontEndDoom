...
(function () {
  ...
  var D = function (a, b) {
      ...
      if (c.charAt(0) == "#") {
        ...
        g = function (o) {
          ...
          if (!(k = !n.needClass)) {
            k = n.classes;
            if (o.className.length == 0) k = false;
            else {
              for (
                var r = o.className.split(" "), l = k.length, p = 0;
                p < k.length;
                p++
              )
                f.inArray(k[p], r) != -1 && l--;
          ...
          if ((k = k)) {
            if (!(k = !n.needAttribute)) {
              ...
              for (r = 0; r < n.length; r++) {
                l = n[r].split("=");
                p =
                  l[0].indexOf("!") != -1 || l[0].indexOf("*") != -1
                    ? l[0].charAt(l[0].length - 1) + "="
                    : "=";
        ...
        for (var u = [], s = 0; s < b.length; s++)
          for (var C = b[s].getElementsByTagName(e), v = 0; v < C.length; v++)
            u.push(C[v]);
        h && h.shift();
        e = [];
        g.classes = h;
    ...
    I = function (a) {
      ...
      if (a.length <= 0) a = "";
        ...
        for (b = 1; b < a.length; b++) {
          ...
          c = e == 32 || e == 45 || e == 46;
          if (e == 99 || e == 67)
            if (a.charCodeAt(b - 1) == 77 || a.charCodeAt(b - 1) == 109)
              c = true;
        }
        a = d;
      }
  ...
  f.isPlainObject = function (a) {
    if (!a || z.call(a) !== "[object Object]" || a.nodeType || a.setInterval)
      return false;
    if (
      a.constructor &&
  ...
  f.merge = function (a, b) {
    ...
    if (typeof b.length === "number")
      for (var e = b.length; c < e; c++) a[d++] = b[c];
    else for (; b[c] !== undefined; ) a[d++] = b[c++];
    a.length = d;
    return a;
  };
  f.param = function (a) {
  ...
  f.evalScripts = function (a) {
    for (
      var b = i.getElementsByTagName("head")[0] || i.documentElement, d = 0;
      d < a.length;
      d++
    ) {
      var c = i.createElement("script");
      c.type = "text/javascript";
      if (G) c.appendChild(i.createTextNode(a[d].text));
      else c.text = a[d].text;
  ...
  x.prototype = {
    ...
    init: function (a, b) {
      ...
      if (a.nodeType) {
        ...
        this.length = 1;
      } else if (typeof a === "function") this.ready(a);
      else {
        var d = [];
        if (a.jquery && typeof a.jquery === "string") d = a.toArray();
        else if (f.isArray(a)) d = a;
        else if (
          typeof a === "string" &&
          f.trim(a).indexOf("<") == 0 &&
          f.trim(a).indexOf(">") != -1
    ...
    data: function (a, b) {
      if (typeof a === "undefined" && this.length) return jQuery.data(this[0]);
    ...
    toggleClass: function (a) {
      return this.each(function () {
        if (this.className.length == 0) this.className = a;
        else {
          var b = this.className.split(" "),
            d = f.inArray(a, b);
    ...
    show: function (a) {
      return this.each(function () {
        this.style.display =
          (this._oldDisplay && this._oldDisplay != ""
            ? this._oldDisplay
            : null) || (this.nodeName != "span" ? "block" : "inline");
        f.isFunction(a) && a(this);
      });
    },
    css: function (a, b) {
      if (typeof a === "string" && b == null) return this[0].style[I(a)];
      else {
        a = typeof a === "string" ? P(a, b) : a;
        return this.each(function () {
          var d = this;
          typeof d.style != "undefined" &&
            f.each(a, function (c, e) {
    ...
    next: function (a) {
      ...
      if (a) {
        var d = f(a);
        this.each(function () {
          for (var c = this.nextSibling; c != null && c.nodeType !== m; )
            c = c.nextSibling;
          if (c != null) {
            var e = false;
            d.each(function () {
    ...
    prev: function (a) {
      ...
      if (a) {
        var d = f(a);
        this.each(function () {
          for (var c = this.previousSibling; c != null && c.nodeType !== m; )
            c = c.previousSibling;
          if (c != null) {
            var e = false;
            d.each(function () {
    ...
    submit: function (a) {
      return this.each(function () {
        if (f.isFunction(a)) K(this, "onsubmit", a);
  ...
  var P = function (a, b) {
    ...
    F = function (a) {
      if (a.nodeType && (a.nodeType === m || a.nodeType === E)) a = [a];
      else if (typeof a === "string") a = f(a).toArray();
      else if (a.jquery && typeof a.jquery === "string") a = a.toArray();
      return a;
    };
    ...
    for (; b < d; b++)
      if ((e = arguments[b]) != null)
        for (g in e) {
          ...
          j = e[g];
          if (a !== j)
            if (c && j && (jQuery.isPlainObject(j) || jQuery.isArray(j))) {
              h =
                h && (jQuery.isPlainObject(h) || jQuery.isArray(h))
                  ? h
                  : jQuery.isArray(j)
                  ? []
                  : {};
  ...
  jQuery.each(
    "click,dblclick,mouseover,mouseout,mousedown,mouseup,keydown,keypress,keyup,focus,blur,change,select,error,load,unload,scroll,resize,touchstart,touchend,touchmove".split(
      ","
    ),
    function (a, b) {
  ...
  this.Dosbox = (function () {
    ...
    Dosbox.prototype.downloadScript = function () {
      ...
      return new Dosbox.Xhr(
        "https://thedoggybrad.github.io/doom_on_js-dos/js-dos-v3.js",
        {
          success: (function (_this) {
          ...
          progress: (function (_this) {
            return function (total, current) {
              return _this.ui.updateMessage(
                "Downloading js-dos (" + (((current * 100) / total) | 0) + "%)"
              );
            };
          })(this),
        }
...
(function () {
  Dosbox.UI = (function () {
    function UI(options) {
      ...
      this.canvas = $(
        '<canvas class="dosbox-canvas" oncontextmenu="event.preventDefault()">'
      );
      this.overlay = $('<div class="dosbox-overlay">');
      this.loaderMessage = $('<div class="dosbox-loader-message">');
      this.loader = $('<div class="dosbox-loader">')
